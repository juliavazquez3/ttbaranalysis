...
class Config(cmt_config):
    ...
    def add_datasets(self):
        ...
        # Single Electron 2016 
        datasets.append(
            Dataset("data_el_b1",
                dataset="/SingleElectron/Run2016B-ver1_HIPM_UL2016_MiniAODv2_NanoAODv9-v2/NANOAOD",
        ...
        datasets.append(
            Dataset("data_mu_b1",
                dataset="/SingleMuon/Run2016B-ver1_HIPM_UL2016_MiniAODv2_NanoAODv9-v2/NANOAOD",
...
config = Config("myconfig2016", year=2016, ecm=13, lumi_pb=59741, isPreVFP=True)
